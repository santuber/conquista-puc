...
function PanelMovimientos({ 
  ...
  const getFacultadesDestino = () => {
    if (!facultadOrigen) return [];
    
    //Aca implementar adyacencias mas adelante
    return facultadesControladas.filter(facultad => 
      facultad.id !== facultadOrigen.id
    );
  };
  ...
  return (
    <div className="panel-movimientos">
      ...
      <p className="info-text">
        Mueve tropas entre tus facultades. Recuerda que debes dejar al menos una tropa en la facultad de origen.
      </p>
          ...
          {facultadOrigen && (
            <div className="form-group">
              ...
              {facultadesDestino.length === 0 ? (
                <p className="warning-text">No tienes otras facultades disponibles como destino.</p>
              ) : (
                <div className="facultades-grid">
                  {facultadesDestino.map((facultad) => (
                    <div
                      ...
                      onClick={() => setFacultadDestino(facultad)}
                    >
                      <div className="facultad-name">{facultad.nombre}</div>
                      <div className="facultad-tropas">
                        Tropas: {getTropasTotal(facultad)}
